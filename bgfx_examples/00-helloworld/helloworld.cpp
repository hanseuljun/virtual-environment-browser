...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ PWSTR pCmdLine, _In_ int nCmdShow)
{
    ...
    global->Set(v8::String::NewFromUtf8(isolate, "bgfx").ToLocalChecked(), bgfx_template.object_template());
    ...
    v8::Context::Scope context_scope(context);
    {
        ...
        if (!veb::read_file(isolate, javascript_file_path.c_str()).ToLocal(&source)) {
            isolate->ThrowException(v8::String::NewFromUtf8(isolate, "Error loading file").ToLocalChecked());
            return 1;
        }
        ...
        while (GetMessage(&msg, NULL, 0, 0))
        {
            ...
            if (!veb::execute_string(isolate, source, true, true)) {
                isolate->ThrowException(v8::String::NewFromUtf8(isolate, "Error executing file").ToLocalChecked());
                return 1;
            }
        }
    }
